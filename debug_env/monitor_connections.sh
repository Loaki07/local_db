...
while true; do
    ...
    # Monitor pods with error handling
    for pod in "monitor-openobserve-router-6cf5fbc8c7-9gsjb" "monitor-openobserve-querier-0" "monitor-openobserve-querier-1" "monitor-openobserve-ingester-0"; do
        monitor_pod "$pod" "monitor" || echo "Failed to monitor $pod"
    done
